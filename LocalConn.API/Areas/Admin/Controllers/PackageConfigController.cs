...
namespace LocalConn.API.Areas.Admin.Controllers
{
    ...
    public class PackageConfigController : ApiController
    {
        ...
        public async Task<string> MakeCoverImage(long PackageID, long ImageID)
        {
            return await objPack.MakeCoverImageAsync(PackageID, ImageID);
        }
        [HttpGet]
        ...
        {
            return await objPack.GetPackageCancellationsAsync(id);
        }
        [HttpPost]
        ...
        [HttpGet]
        [Route("OfferPackagelist")]
        public async Task<IEnumerable<long>> OfferPackageList(long id)
        {
            return await objPack.GetOfferPackageAsync(id);
        }
